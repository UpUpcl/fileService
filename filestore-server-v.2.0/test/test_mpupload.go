...
func main() {
	username := "root"
	token := "20b121f37390edf295fe2709df86f8306191ecdb"
	filehash := "80d48e57539a1347b27cefc11001b4697a17daae"
	...
	// 3. 请求分块上传接口
	filename := "/Users/chenlei/GolandProjects/src/filestore-server/go1.10.3.linux-amd64.tar"
	...
	resp, err = http.PostForm(
		...
		url.Values{
			...
			"filehash": {filehash},
			"filesize": {"365812736"},
			"filename": {"go1.10.3.linux-amd64.tar"},
			"uploadid": {uploadID},
		})
